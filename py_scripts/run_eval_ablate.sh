...
for DENSITY in 0.06 0.04 0.02; do
  ...
  CODE_INPUT="--input_path ../redial/perturbations/typo/$DENSITY/algorithm.json"
  LOGIC_INPUT="--input_path ../redial/perturbations/typo/$DENSITY/logic.json"
  MATH_INPUT="--input_path ../redial/perturbations/typo/$DENSITY/math.json"
  COMPREHENSIVE_INPUT="--input_path ../redial/perturbations/typo/$DENSITY/comprehensive.json"
...
for DENSITY in 1 0.75 0.5 0.25; do
  ...
  CODE_INPUT="--input_path ../redial/perturbations/multivalue/$DENSITY/algorithm.json"
  LOGIC_INPUT="--input_path ../redial/perturbations/multivalue/$DENSITY/logic.json"
  MATH_INPUT="--input_path ../redial/perturbations/multivalue/$DENSITY/math.json"
  COMPREHENSIVE_INPUT="--input_path ../redial/perturbations/multivalue/$DENSITY/comprehensive.json"
